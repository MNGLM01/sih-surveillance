...
const DEMO_SCENARIOS: Array<{ camera_id: string; track_id: string; object_class: string; reasons: string[]; score: number }> = [
  {
    ...
    track_id: 'cam1:P-52',
    object_class: 'person',
    reasons: ['Near virtual fence (Perimeter Buffer): +45'],
    score: 45,
  },
  {
    camera_id: 'cam2',
    track_id: 'cam2:P-33',
    object_class: 'person',
    reasons: ['Virtual fence intrusion (North Fence Perimeter): +90'],
    score: 90,
  },
  {
    camera_id: 'cam1',
    track_id: 'cam1:P-88',
    object_class: 'person',
    reasons: ['Restricted camera zone breach (Person detected): +95'],
    score: 95,
  },
  {
    camera_id: 'cam3',
